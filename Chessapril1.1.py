...
creds_dict = {
    "type": st.secrets["GOOGLE_SHEETS_KEY"]["type"],
    "project_id": st.secrets["GOOGLE_SHEETS_KEY"]["project_id"],
    "private_key_id": st.secrets["GOOGLE_SHEETS_KEY"]["private_key_id"],
    "private_key": st.secrets["GOOGLE_SHEETS_KEY"]["private_key"],
    "client_email": st.secrets["GOOGLE_SHEETS_KEY"]["client_email"],
    "client_id": st.secrets["GOOGLE_SHEETS_KEY"]["client_id"],
    "auth_uri": st.secrets["GOOGLE_SHEETS_KEY"]["auth_uri"],
    "token_uri": st.secrets["GOOGLE_SHEETS_KEY"]["token_uri"],
    "auth_provider_x509_cert_url": st.secrets["GOOGLE_SHEETS_KEY"]["auth_provider_x509_cert_url"],
    "client_x509_cert_url": st.secrets["GOOGLE_SHEETS_KEY"]["client_x509_cert_url"],
    "universe_domain": st.secrets["GOOGLE_SHEETS_KEY"]["universe_domain"],
}
